...
/**
 * 进入 d：\redis ;redis-server.exe redis.windows.conf
 * @author wdd-think
 *
 */
...
//	        jedis.hdel("user","pwd"); 
	...
	*/ 
	...
	//开始前，先移除所有的内容 
	jedis.del("java frameworks"); 
	System.out.println(jedis.lrange("java frameworks",0,-1)); 
	//先向key java framework中存放三条数据 
	jedis.lpush("java frameworks","springs"); 
	jedis.lpush("java frameworks","strutss"); 
	jedis.lpush("java frameworks","hibernates"); 
